...
#remove weekends
trading_dates<- trading_period[isWeekday(trading_period)]; #actual trading dates within the period
...
#c = BlackScholes76CallPrice(1.3544, 1.3415, 0.073, 0.0065, 0.0045, 17.0/252.0)*10000000
#c
